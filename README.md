...
- https://apex-canvass-poc.netlify.app
- https://uplot-canvass-poc.netlify.app
...
Libraries are shareable across libraries and applications. They can be imported from `@charts-poc-mono/mylib`.
